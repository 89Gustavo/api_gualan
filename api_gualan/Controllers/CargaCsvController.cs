...
namespace api_gualan.Controllers
{
    ...
    public class CargaCsvController : ControllerBase
    {
       ...
       public CargaCsvController(IDbHelper db, IConfiguration config)
        ...
        public async Task<IActionResult> CargarColocacionBatchMasiva(IFormFile archivo,[FromQuery] string usuarioBitacora)
        {
            ...
            } else if (_config["TipoConexion"] == "SqlServer")
            {
                ...
                return Ok(_config["Conexión no configurada."]);
            }
        }
        ...
        public async Task<IActionResult> CargarCtasInternasMasivoLimpio(IFormFile archivo,[FromQuery] string usuarioBitacora)
        {
            var stopwatch = Stopwatch.StartNew();
            if (_config["TipoConexion"] == "MySql")  {
                try
        ...
        public async Task<IActionResult> CargarDatosTransaccionesMasivoLimpio(IFormFile archivo,[FromQuery] string usuarioBitacora)
        {
            var stopwatch = Stopwatch.StartNew();
            if (_config["TipoConexion"] == "MySql") { 
                try
